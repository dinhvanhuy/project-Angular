...
export class UserService {
	...
	userUrl = 'https://conduit.productionready.io/api/profiles';
	...
	getUserDetail(userName: string): Observable<Profile> {
		...
		this.httpClient.get<Profile>(`${this.userUrl}/${userName}`, {headers: this.httpHeader}) :
		this.httpClient.get<Profile>(`${this.userUrl}/${userName}`);
	}
